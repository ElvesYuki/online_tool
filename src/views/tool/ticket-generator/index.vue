<template>
  <div>准考证生成</div>
  <RichTextCom ref="content"></RichTextCom>
...
<script setup lang="ts">
  ...
  const test = () => {
    const contentHtml = content.value.getEditorHtml();
    console.log(contentHtml);
    htmlContent.value = contentHtml;
    htmlToPdf("test", contentHtml)
  };

  const htmlToPdf = (title: string, contentHtml: string) => {
